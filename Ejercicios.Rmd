...
*Crear un plot con lineas y puntos mostrando las diferencias consecutivas de C02
en función del tiempo (1960, 1961, etc…), en **negrita**

*La diferencia de concentración de C02 entre 2020 y 2019 fue igual a 2.64. Agregar un punto rojo representando esa diferencia al plot ya creado (usar una forma diferente, como pch=4)
